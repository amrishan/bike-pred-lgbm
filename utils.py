...
def numericalize(df, col, name, max_n_cat):
    ...
    2     3    a    1
    """
    if not is_numeric_dtype(col) and ( max_n_cat is None or len(col.cat.categories)>max_n_cat): #( max_n_cat is None or col.nunique()>max_n_cat):
...
def plot_lift_curve(y_true, probas_list, 
                    clf_names=None,
                    title='Lift Curve',
                    ax=None, figsize=None, title_fontsize="large",
                    text_fontsize="medium", cmap='nipy_spectral'):
    
    for i, y_probas in enumerate(probas_list):
        ...
        #percentages, gains1 = skplt.metrics.cumulative_gain_curve(y_true, y_probas[:, 0],
        #                                            classes[0])
        percentages, gains2 = skplt.metrics.cumulative_gain_curve(y_true, y_probas[:, 1],
                                                    classes[1])
        ...
        ax.plot(percentages, gains2, lw=3, label=clf_names[i], color=color)
...
def plot_cum_gain_curve(y_true, probas_list, 
                    clf_names=None,
                    title='Lift Curve',
                    ax=None, figsize=None, title_fontsize="large",
                    text_fontsize="medium", cmap='nipy_spectral'):
